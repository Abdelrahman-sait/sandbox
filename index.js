$(document).ready(function() {
    ...
    $('#like img').click(function() {
        ...
        if (likeCount > 0) {
            $(this).attr('src', 'like_icon_colored.png');
        }
    }).dblclick(function() {
        likeCount = 0;
        $('#like-count').text(likeCount);
        $(this).attr('src', 'like_icon_grey.png');
    });
    ...
    $('#share img').click(function() {
        ...
        if (shareCount > 0) {
            $(this).attr('src', 'share_icon_colored.png');
        }
    }).dblclick(function() {
        shareCount = 0;
        $('#share-count').text(shareCount);
        $(this).attr('src', 'share_icon_grey.png');
    });
    ...
    $('#bookmark img').click(function() {
        ...
        if (bookmarkCount > 0) {
            $(this).attr('src', 'bookmark_icon_colored.png');
        }
    }).dblclick(function() {
        bookmarkCount = 0;
        $('#bookmark-count').text(bookmarkCount);
        $(this).attr('src', 'bookmark_icon_grey.png');
    });
